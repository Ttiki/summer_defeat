...
class CollisionTrigger : public Component//Component
{
public: 
    ...
    virtual void Collide(shared_ptr<Entity> collidedentity, const Vec3& position, const Vec3& normal, const float speed);//out
