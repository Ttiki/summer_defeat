...
#define TONEMAPPING_REINHARD 2
#define TONEMAPPING_REINHARD2 3
#define TONEMAPPING_UNCHARTED2 4
#define TONEMAPPING_UNREAL 5
#define TONEMAPPING_UCHIMURA 6
#define TONEMAPPING_NEUTRAL 7
#define TONEMAPPING_LOTTES 8
#define TONEMAPPING_FILMIC 9
#define TONEMAPPING_AGX 10

vec3 ApplyToneMapping(vec3 c, int mode)
{
  ...
  case TONEMAPPING_REINHARD:
    c = reinhard(c);
    break;
  case TONEMAPPING_REINHARD2:
    c = reinhard2(c);
    break;    
  case TONEMAPPING_UCHIMURA:
    c = uchimura(c);
    break;
  case TONEMAPPING_UNCHARTED2:
    c = uncharted2(c);
    break;
  case TONEMAPPING_UNREAL:
    return unreal(c);// Linear to sRGB conversion is handled in this function
    break;
  case TONEMAPPING_NEUTRAL:
