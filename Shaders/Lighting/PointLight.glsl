...
layout(binding = 11) uniform samplerCube BaseColorMap;

// Includes
#include "../Common/Constants.glsl"
#include "Light.glsl"
#include "DrawPointLight.glsl"
...
void main()
{
    ...
    #define n 0
...
#endif
        samplecoord.z = texelFetch(DepthBuffer, coord, n).r;
        if (samplecoord.z < 1.0)
        {
            ...
            if (fogstrength < 1.0) DrawPointLight(n, albedo.rgb, normal, position, diffuse, specular, occlusion, roughness, metalness, flags);
        }
#ifdef MSAASAMPLES
    }
